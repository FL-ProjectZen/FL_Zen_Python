...
--------------------------------------------------------------------------------------------
Operator | Name           | Meaning / Logic                          | Example   | Output
--------------------------------------------------------------------------------------------
&        | Bitwise AND    | 1 only if both bits are 1                | 10 & 7    | 2
|        | Bitwise OR     | 1 if either bit is 1                     | 10 | 7    | 15
~        | Bitwise NOT    | Flip bits, two’s complement              | ~10       | -11
^        | Bitwise XOR    | 1 if bits differ                         | 10 ^ 7    | 13
<<       | Left Shift     | Shift left → multiply by 2ⁿ              | 10 << 2   | 40
>>       | Right Shift    | Shift right → divide by 2ⁿ               | 10 >> 1   | 5
--------------------------------------------------------------------------------------------
