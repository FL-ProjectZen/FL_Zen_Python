...
"""
---------------------------------------------------------------------
Module    Chapter        Engineering Foundation Primer
---------------------------------------------------------------------
Python    4.Operators	 Requirement → Scenario → Test Case Thinking
---------------------------------------------------------------------

Before discussing about Operators,in this section let us discuss about 
    1. Readable Code Mindset
