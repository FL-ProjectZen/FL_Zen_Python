...
---------------
    A. Requirement
    B. Test Scenario vs Test Case
    C. Simple Example
    D. Test Scenario vs Test Case
'''
...
Test Scenario: Describes what behavior must be tested, without worrying about specific input values
                WHAT TO TEST --> High Level "Behavior" 
                                 Addition of two numbers should work correctly.
...
| Example     | “Add 2 numbers”                       | Input: 4 + 5 → Expected: 9              |
...
# REQUIREMENT: Print the result of addition of  2 numbers
...
D. Test Scenario vs Test Case:
------------------------------
Requirement : Print result of addition of numbers
