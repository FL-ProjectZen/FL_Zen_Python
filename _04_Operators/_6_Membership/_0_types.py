...
| Operator | Meaning / Logic                                       | Math Interpretation    | Python Example              | Output |
| ---------| ----------------------------------------------------- | -----------------------| --------------------------- | ------ |
| in       | Checks if an element exists inside a sequence         | Membership → x ∈ S     | python : "F" in "Ferilion"  | True   |
| not in   | Checks if an element does NOT exist inside a sequence | Non-membership → x ∉ S | python\n10 not in [1, 2, 3] | True   |


Sequences: 
-----------
| ------------------------------------------------ |
| S.No | Sequence Name | Example                   |
| ------------------------------------------------ |
| 1    | String        | "Ferilion"                |
| 2    | List          | [10, 20, 30, "mad", True] |
| 3    | Tuple         | (10, 20, 30)              |
| 4    | Range         | range(1, 6)               |
| 5    | Bytes         | b"hello"                  |
| 6    | Bytearray     | bytearray(b"Ferilion")    |
| ------------------------------------------------ |
